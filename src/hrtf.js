export function HRTFContainer() {
  ...
  this.loadHrir = async function (file) {
...
*/
export function HRTFPanner(audioContext, sourceNode, hrtfContainer) {
  ...
  this.update = function (azimuth, elevation) {
    targetConvolver.fillBuffer(
      hrtfContainer.interpolateHRIR(azimuth, elevation)
    );
    // start crossfading
...
*/
export function cartesianToInteraural(x1, x2, x3) {
